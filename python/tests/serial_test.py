...
& C:/Python27/python.exe "d:/Stromarija/Damogran Labs/Simple Data Protocol/python/serial_test.py"
& "C:/Program Files (x86)/Python36-32/python.exe" "d:/Stromarija/Damogran Labs/Simple Data Protocol/python/serial_test.py"
python "d:/Stromarija/Damogran Labs/Simple Data Protocol/python/serial_test.py"

& "C:/Program Files (x86)/Python36-32/Scripts/ipython.exe" "d:/Stromarija/Damogran Labs/Simple Data Protocol/python/serial_test.py"

python2 "/home/plejr/Desktop/sdp/serial_test.py"
python3 "/home/plejr/Desktop/sdp/serial_test.py"
...
def thread_it():
    ...
    if not rx_thread_flag:
        threading.Timer(RX_THREAD_SLEEP, thread_it).start()
...
def main():
    ...
    #th = threading.Timer(0.1, thread_it)
    #th.start()
    thread_it()

...
# & C:/Python27/python.exe "d:/Stromarija/Damogran Labs/Simple Data Protocol/python/serial_test_timer.py"
# & "C:/Program Files (x86)/Python36-32/python.exe" "d:/Stromarija/Damogran Labs/Simple Data Protocol/python/serial_test_timer.py"
# python "d:/Stromarija/Damogran Labs/Simple Data Protocol/python/serial_test_timer.py"

python2 "/home/plejr/Desktop/sdp/serial_test_timer.py"
python3 "/home/plejr/Desktop/sdp/serial_test_timer.py"
...
def main():
    ...
    rx_timer = threading.Timer(0.1, thread_it)
    rx_timer.start()
